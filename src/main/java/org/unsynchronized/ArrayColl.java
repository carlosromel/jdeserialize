...
/**
 * <p>
 * Typed collection used for storing the values of a serialized array.  </p>
 *
 * <p>
 * Primitive types are stored using their corresponding objects; for instance,
 * an int is stored as an Integer. To determine whether or not this is an array
 * of ints or of Integer instances, check the name in the arrayobj's class
 * description.</p>
 */
