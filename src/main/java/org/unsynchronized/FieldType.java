...
/**
 * <p>
 * Enum class that describes the type of a field encoded inside a classdesc
 * description.
 * </p>
 *
 * <p>
 * This stores both information on the type (reference/array vs. primitive) and,
 * in cases of reference or array types, the name of the class being referred
 * to.
 * </p>
 */
public enum FieldType {
     ...
     *
     * @param ch the character representing the type (must match one of those
     * listed in prim_typecode or obj_typecode in the Object Serialization
     * Stream Protocol)
     */
    FieldType(char ch) {
        this(ch, null);
     ...
     * listed in prim_typecode or obj_typecode in the Object Serialization
     * Stream Protocol)
     * @param javatype the name of the object class, where applicable (or null
     * if not)
     */
     ...
     *
     * @return the type code character for this field; values will be one of
     * those in prim_typecode or obj_typecode in the protocol spec
     */
    public char ch() {
        return ch;
    }
