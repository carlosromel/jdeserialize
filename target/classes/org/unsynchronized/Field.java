...
/**
 * This class represents a field within a class description/declaration
 * (classdesc). It contains information about the type and name of the field.
 * Fields themselves don't have a handle; inside the stream, they exist only as
...
public class Field {
    ...
    /**
     * Tells whether or not this class is an inner class reference. This value
     * is set by connectMemberClasses() -- if this hasn't been called, or if the
     * field hasn't been otherwise set by setIsInnerClassReference(), it will be
     * false;
     *
    ...
    /**
     * Sets the flag that denotes whether this class is an inner class
     * reference.
     *
     * @param nis the value to set; true iff the class is an inner class
     * reference.
     */
    ...
    /**
     * Changes the name of an object reference to the name specified. This is
     * used by the inner-class-connection code to fix up field references.
     *
