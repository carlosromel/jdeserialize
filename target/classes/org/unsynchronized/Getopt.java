...
public class Getopt {
    ...
    /**
     * Gets the list arguments specified that were *not* options or their
    ...
    /**
     * Gets the set of all options specified, as well as the list of their
     * arguments.
     *
     ...
     * Constructor.
     *
     * @param options Map of options to parse. The key should be an option
     * string (including any initial dashes), and the value should be an Integer
     * representing the number of arguments to parse following the option.
    ...
    /**
     * Determines whether or not the option was specified when the arguments
     * were parsed.
     *
     * @return true iff the argument was specified (with the correct number of
     * arguments).
     */
    ...
    /**
     * Gets the list of arguments for a given option, or null if the option
     * wasn't specified.
     *
    ...
    /**
     * Add an option to the internal set, including the number of arguments and
     * the description.
     *
     ...
     * @throws OptionParseException if a parse error occurs (the exception
     * message will have details)
     */
    ...
    /**
     * Get a tabular description of all options and their descriptions, one per
     * line.
     */
