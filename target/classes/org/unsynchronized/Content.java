...
public interface Content {
    ...
    /**
     * <p>
     * Get the numeric handle by which this object was referred to in the object
     * stream. These handles are used internally by Object{Output,Input}Stream
     * as a mechanism to avoid costly duplication.
     * </p>
     *
     * <p>
     * CAUTION: they are *not* necessarily unique across all objects in a given
     * stream! If an exception was thrown during serialization (which is most
     * likely to happen during a serialized objct's writeObject()
     * implementation), then the stream resets before and after the exception is
     * serialized.
     * </p>
     *
     ...
     *
     * <p>
     * <b>Note</b>: Not every Throwable or Exception in the stream will have
     * this flag set to true; only those which were thrown <i>during
     * serialization</i> will
     * </p>
     *
    ...
    /**
     * Sets the flag that tells whether or not this object is an exception that
