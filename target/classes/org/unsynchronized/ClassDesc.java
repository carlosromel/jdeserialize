...
public class ClassDesc extends ContentBase {
    ...
    /**
     * Type of the class being represented; either a normal class or a proxy
     * class.
     */
    ...
    /**
     * Array of fields in the class, in the order serialized by the stream
     * writer.
     */
    public Field[] fields;
     ...
     * written by the
     * <pre>annotateClass(Class<?>)<pre> and <pre>annotateProxyClass(Class<?>)</pre>
    ...
    /**
     * Array of serialized interfaces, in the order serialized by the stream
     * writer.
     */
     ...
     * serialized even though their enclosing class is not. In these cases, this
     * may return false. See connectMemberClasses() for details.
     * </p>
     *
    ...
    /**
     * Generates a list of all class descriptions in this class's hierarchy, in
     * the order described by the Object Stream Serialization Protocol. This is
     * the order in which fields are read from the stream.
     *
